...
#ifndef UWBIOT_APP_BUILD__DEMO_FL_RESPONDER
#include "UWBIOT_APP_BUILD.h"
#endif

#ifdef UWBIOT_APP_BUILD__DEMO_FL_RESPONDER

#define DEMO_FIRALITE_TASK_SIZE       2048
#define DEMO_FIRALITE_TASK_NAME       "firalite_responder"
...
{
    PRINT_APP_NAME("Demo FiraLite Responder");
...
#endif // (UWBIOT_APP_BUILD__DEMO_FL_RESPONDER
