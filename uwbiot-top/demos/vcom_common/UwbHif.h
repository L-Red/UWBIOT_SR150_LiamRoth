...
#include "uwb_board.h"
    ...
    defined(CPU_LPC54628J512ET180) || defined(CPU_MIMXRT1176DVMAA)
#include "Uwb_usb.h"
...
#define MCTT_UCI_HEADAER              0x04
#define MCTT_SE_GID_HEARDER           0x80
#define MCTT_DATA_PAYLOD_LENGTH_INDEX 0x02
#define MCTT_GID_INDEX                0x00
#define MCTT_UCI_PAYLOD_LENGTH_INDEX  0x03
#define MCTT_DATA_SEND                0x01
#define MCTT_DATA_RECV                0x02
#define MCTT_LL_DATA_SEND             0x03
#define MCTT_LL_DATA_RECV             0x04
...
#define HIF_RESP_BUFF_SIZE 4104 // Max CIR payload data: 4096 + 4 byte session Id + 4 byte CDC header
#define HIF_MAX_PKT_SIZE   4100
