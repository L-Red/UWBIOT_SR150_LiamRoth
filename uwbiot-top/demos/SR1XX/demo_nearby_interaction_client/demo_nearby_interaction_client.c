...
/********************************************************************************/
#define DEMO_NEARBY_INTERACTION_TASK_SIZE 1024
#define DEMO_NEARBY_INTERACTION_TASK_NAME "DemoBleTrackerCounterpart"
#define DEMO_NEARBY_INTERACTION_TASK_PRIO 4

#if DEMO_NEARBY_INTERACTION_TASK_SIZE > 1024
...
{
    PRINT_APP_NAME("Demo BLE Tracker counterpart");
    tUWBAPI_STATUS status = UWBAPI_STATUS_FAILED;

#if DEMO_NEARBY_INTERACTION_TASK_SIZE > 1024
    status = UWBAPI_STATUS_OK;
    LOG_W("Skipping demo as DEMO_NEARBY_INTERACTION_TASK_SIZE > 1024");
#else
    ...
    main_task(0);
#endif //CPU_JN518X
#endif // DEMO_NEARBY_INTERACTION_TASK_SIZE
...
UWBOSAL_TASK_HANDLE uwb_demo_start(void)
{
    ...
    threadparams.stackdepth   = DEMO_NEARBY_INTERACTION_TASK_SIZE;
    PHOSALUWB_SET_TASKNAME(threadparams, DEMO_NEARBY_INTERACTION_TASK_NAME);
    threadparams.pContext = NULL;
    threadparams.priority = DEMO_NEARBY_INTERACTION_TASK_PRIO;
