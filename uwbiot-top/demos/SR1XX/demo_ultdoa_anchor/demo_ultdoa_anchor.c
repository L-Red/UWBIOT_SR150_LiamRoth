...
#ifndef UWBIOT_APP_BUILD__DEMO_ULTDOA_ANCHOR
#include "UWBIOT_APP_BUILD.h"
#endif

#ifdef UWBIOT_APP_BUILD__DEMO_ULTDOA_ANCHOR
...
#define DEMO_TDOA_ANCHOR_TASK_NAME "DemoULTDoAAnchor"
...
OSAL_TASK_RETURN_TYPE StandaloneTask(void *args)
{
    ...
    PRINT_APP_NAME("Demo UL-TDOA Ranging Anchor");
    ...
    inRangingParams.deviceRole        = kUWB_DeviceRole_UT_Anchor;
...
#endif // (UWBIOT_APP_BUILD__DEMO_ULTDOA_ANCHOR)
