...
#ifndef UWBIOT_APP_BUILD__DEMO_DLTDOA_RESPONDER
#include "UWBIOT_APP_BUILD.h"
#endif

#ifdef UWBIOT_APP_BUILD__DEMO_DLTDOA_RESPONDER
 ...
 * };
 */
uint8_t addList1[] = {0x11, 0x11};

const phActiveRoundsConfig_t activeRoundsConfig[] = {{.roundIndex = 0, .rangingRole = kUWB_DeviceRole_Responder},
    {.roundIndex                 = 1,
        ...
        .responderSlots          = NULL},
    {.roundIndex = 2, .rangingRole = kUWB_DeviceRole_Responder},
    {.roundIndex                 = 3,
        .rangingRole             = kUWB_DeviceRole_Initiator,
        .noofResponders          = 1,
        .responderMacAddressList = addList1,
...
static tUWBAPI_STATUS ApplySessionConfig()
{
    ...
    const UWB_AppParams_List_t SetAppParamsList[] = {UWB_SET_APP_PARAM_VALUE(RANGING_DURATION, 200),
        ...
        UWB_SET_APP_PARAM_VALUE(DLTDOA_TX_TIMESTAMP_CONF, DLTDOA_ANCHOR2_TIMEBASE_64BIT)};
...
{
    PRINT_APP_NAME("Demo DLTDOA Anchor2");
    tUWBAPI_STATUS status;
...
#endif //UWBIOT_APP_BUILD__DEMO_DLTDOA_RESPONDER
