...
/** Helios SR110T */
#define UWBIOT_UWBD_SR110T 0

/** SR160 with or without SE051W
 *
 * If you want to select SE051W, use Applet=SE051_UWB
 * If you want to skip SE051W, use Applet=None */
#define UWBIOT_UWBD_SR160 0

/** NXP Internal */
#define UWBIOT_UWBD_SR200T 0

/** NXP Internal */
#define UWBIOT_UWBD_SR250 0
...
#define UWBFTR_ChainedUCI \
 (UWBFTR_UL_TDoA_Anchor | UWBFTR_DL_TDoA_Tag | UWBFTR_UWBS_DEBUG_Dump | UWBFTR_Radar | UWBFTR_DataTransfer)
...
#define UWBFTR_SE_SE051W 1

/* Temporary */

#define UWBIOT_HOST_RASPBIAN 0
